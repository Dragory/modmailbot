...
**Note:** No guideline here, as this depends on your own processes and privacy policy.

**Note:** To abide by the [Discord Developer Terms of Service](https://support-dev.discord.com/hc/en-us/articles/8562894815383-Discord-Developer-Terms-of-Service), you must ensure your bot's database is encrypted at rest. You can achieve this with e.g. full disk encryption, encrypted volumes, or database encryption settings.
...
Note that this intent is only required if you use the bot's server greetings feature.
